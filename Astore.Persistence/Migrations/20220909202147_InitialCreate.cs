    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    UserProfileUserId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleUserProfile", x => new { x.FavoritedByUserId, x.FavoritesId });
                    table.ForeignKey(
                        name: "FK_ArticleUserProfile_Articles_FavoritesId",
                        column: x => x.FavoritesId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleUserProfile_UserProfiles_FavoritedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_UserProfiles_UserProfileUserId",
                        column: x => x.UserProfileUserId,
                        principalTable: "UserProfiles",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_UserProfiles_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleUserProfile_FavoritesId",
                table: "ArticleUserProfile",
                column: "FavoritesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_UserProfileUserId",
                table: "CartItems",
                column: "UserProfileUserId");
